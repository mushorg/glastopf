...
import sql_utils.SQLiteLexer as Lexer
import sql_utils.SQLiteParser as Parser
...
class SQLParser(object):
    ...
    def _lexical_analysis(self, query):
        ...
        lexer = Lexer.SQLiteLexer(query_stream)
        for token in lexer:
    ...
    def _parse_tokens(self, token_stream, parser_rule):
        ret = None
        self.parser = Parser.SQLiteParser(token_stream)
        try:
